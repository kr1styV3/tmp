...
def main():
    ...
    print("Please select the logo image.")
    ...
    artists = []
    artist_counter = 0
    print("Now, let's upload artist images. Select images one by one. Click 'Cancel' when done.")
    while True:
        print("Please select an artist image.")
        artist_image_path = filedialog.askopenfilename(
    ...
    print("Now, let's upload normal images. Select images one by one. Click 'Cancel' when done.")
    while True:
        print("Please select a normal image.")
        normal_image_path = filedialog.askopenfilename(
            title="Select Normal Image",
            initialdir=os.path.expanduser('~/Downloads'),
            filetypes=[("Image files", ("*.jpg", "*.jpeg", "*.png", "*.gif", "*.bmp"))]
        )
